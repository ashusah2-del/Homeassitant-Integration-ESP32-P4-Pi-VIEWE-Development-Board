...
# Local patch: ESP32-P4 supports PDM RX on I2S0 (SOC_I2S_SUPPORTS_PDM_RX;
# the vendor demo for this board drives the MSM261D mic exactly this way),
# but upstream's allowlist predates the P4. The C++ side is variant-agnostic.
